            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group mb-3 m-2 col">
                            <label class="input-group-text" for="airport_code">Аэропорт задержки</label>
                        ...
                        <div class="input-group mb-3 m-2 col">
                            <label class="input-group-text" for="airport_code">Номер рейса</label>
                            <select class="form-select" id="inputGroupSelect03" v-model="flight_number"
                                    @change="fetchData">
                                <template v-for="airport in flights" :key="airport.flight_number">
                                    <option :value="airport.flight_number">{{ airport.flight_number }}</option>
                                </template>
                            </select>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered table-hover" id="dataTable">
                        ...
                        <template v-for="boardingTakeoff in boardingTakeoffs" :key="boardingTakeoff.id">
                            <tr>
                                ...
                                <td>{{ boardingTakeoff.Departure_Airport}}</td>
                                <td>{{ boardingTakeoff.Destination_Airport}}</td>
