                    ...
                    <div class="card-body">
                        <div class="input-group">
                            <select class="form-select" id="inputGroup" v-model="selectedType" aria-label="Example select with button addon">
                                ...
                                <option value="is_reason_status">Статус задержки</option>
                            </select>
    ...
    data() {
        return {
            ...
            options: [
                ...
                { value: 'is_reason_status', label: 'Статус задержки' }
            ],
        }
    },
    methods: {
        async fetchData() {
            try {
                this.categories = await this.getType(this.selectedType);
            } catch (error) {
                console.error(error);
            }
        },
